...
JENKINS_HOME_BIND="${LEGACY_HOME}" EXTERNAL_URL="${EXTERNAL_URL}" JENKINS_ADMIN_USER="${JENKINS_ADMIN_USER}" JENKINS_DEVELOPER_GROUP="${JENKINS_DEVELOPER_GROUP}" docker compose -f "${COMPOSE_FILE}" down
JENKINS_HOME_BIND="${LEGACY_HOME}" EXTERNAL_URL="${EXTERNAL_URL}" JENKINS_ADMIN_USER="${JENKINS_ADMIN_USER}" JENKINS_DEVELOPER_GROUP="${JENKINS_DEVELOPER_GROUP}" docker compose -f "${COMPOSE_FILE}" up -d --build
