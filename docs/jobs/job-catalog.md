...
| Build-Docker-General-Agent-Image | Pipeline | `jobs/templates/pipeline_job_build_general_agent_image.groovy` + `pipelines/apps/build-docker-general-agent-image.Jenkinsfile` | Platform | Builds `general-agent.Dockerfile` with Jenkins-controlled version build args |
